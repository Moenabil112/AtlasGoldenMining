import { offtake } from '../data/atlasCopper'
...
export function OfftakeSection() {
  return (
    <SovereignContainer id="offtake" tone="ivory">
      <SectionHeader index="12" title={offtake.titleAr} headline={offtake.headlineAr} />

      <div className="grid items-start gap-10 lg:grid-cols-5">
        <Reveal className="lg:col-span-3">
          <p className="leading-loose text-charcoal-700">{offtake.bodyAr}</p>
          <ul className="mt-8 grid gap-x-8 gap-y-3.5 sm:grid-cols-2">
            {offtake.itemsAr.map((item) => (
              <li
                key={item}
        ...
        <Reveal delayMs={150} className="lg:col-span-2">
          <ImagePanel
            ...
            labelAr="تخصيص وتسوية كاثود النحاس"
